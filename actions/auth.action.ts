...
import { forgotUserPassword, register, resetUserPassword, updateUserPassword, updateUserProfile } from "../backend/controller/auth.controller"
...
export async function updateProfile({
  ...
  oldAvatar?: string;
    ...
    name,userEmail: email, avatar, oldAvatar,})
}
