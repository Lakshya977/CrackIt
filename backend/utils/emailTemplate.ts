export const resetPasswordHTMLTemplate = (username: string, resetUrl: string) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>
                          ...
                          CrackIt account. Use the button below to reset it.
                          <strong
                        ...
                        <p>Thanks, <br />The CrackIt team</p>
                  ...
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">
                       CrackIt
                        <br />1-21, Ashoka Road <br />Suite 1234
                      </p>
                    </td>
                  </tr>
                </table>
